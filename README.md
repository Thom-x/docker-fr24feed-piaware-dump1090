...
| `ADSBEXCHANGE_MLAT`                   | `mlat`                   | `yes`             |

Configure the MLAT coordinates so that adsbexchange MLAT can work.
If you don't want to put in your exact coordinates, please set the `ADSBEXCHANGE_MLAT` environment variable to `no`.
